...
\project{ZeroWhats}{Rust, TypeScript, Tauri}{Cliente desktop focado em privacidade para WhatsApp Web, constru\'ido com Tauri e Preact, substituindo o peso do Electron por recursos nativos como bloqueio do app e notifica\c{c}\~oes do sistema.}
\project{indago}{TypeScript, SQLite}{Toolkit de CMS headless local que transforma conte\'udo Markdown/MDX e JSON em uma camada tipada e buscavel com FTS5, sem necessidade de backend.}
\vspace{-10pt}
