...
\begin{center}
    ...
    \href{https://zaujulio.vercel.app}{Portf\'olio: zaujulio.vercel.app}
\end{center}
...
Tech Lead e Engenheiro de Software Full Stack m\~ao na massa, com mais de 5 anos construindo sistemas escal\'aveis e de alta concorr\^encia ao longo de todo o ciclo de vida do software. Profundo dom\'inio do ecossistema \textbf{TypeScript / Node.js} (\textbf{GraphQL}, Express, NestJS) e de \textbf{Python} para \textbf{IA, Machine Learning, Deep Learning, NLP e s\'eries temporais}. Projeta \textbf{microsservi\c{c}os} orientados a eventos com filas de processamento (BullMQ, RabbitMQ), modela dados relacionais e NoSQL (PostgreSQL, MySQL/MariaDB, MongoDB) e \'e respons\'avel pela entrega de ponta a ponta---da modelagem Entidade-Relacionamento e servi\c{c}os \textbf{C\# / .NET} a CI/CD, infraestrutura Linux e otimiza\c{c}\~ao de custos em nuvem. \textbf{1\textsuperscript{o} lugar mundial em GraphQL no CodersRank}. Come\c{c}ou a programar antes da onda de IA e hoje \'e fluente em desenvolvimento assistido por IA, liderando times sem deixar de entregar c\'odigo em produ\c{c}\~ao diariamente.
...
\begin{itemize}[leftmargin=14pt, itemsep=2pt, topsep=0pt]
    ...
    \item Reduzi os tempos de build de CI/CD em 75\% (de 20 min para menos de 5) e o custo mensal na AWS em \textasciitilde80\% (de US\$120 para US\$25) com otimiza\c{c}\~oes de infraestrutura direcionadas. Redimensionei servi\c{c}os Node.js em produ\c{c}\~ao de 4 para 2 n\'ucleos com metade da RAM e a mesma vaz\~ao, e enxuguei ambientes de desenvolvimento Docker de 2 GB para 250 MB de mem\'oria.
...
\project{weasyprint-pdf-render}{Python, Docker}{Microsservi\c{c}o de renderiza\c{c}\~ao HTML-para-PDF de alta performance, conteinerizado para escala horizontal.}
